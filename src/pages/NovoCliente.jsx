...
export default function NovoCliente() {
  ...
  async function handleSubmit() {
    ...
    setSaving(false)
    if (error) {
      return setErro(error.message.includes('unique') ? 'Já existe um cliente com esse CPF/CNPJ.' : error.message)
    }
  ...
  return (
    <div style={{ maxWidth: 680 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: 'var(--text2)', fontSize: 13 }}>Cadastre os dados do cliente. Os protestos podem ser adicionados depois na tela de detalhes.</p>
      </div>
